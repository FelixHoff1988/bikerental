 ...
 * @author Nisa 
 * 
 * Diese Klasse repräsentiert die GUI zum Melden von defekten Fahrraedern.
 * Der User gibt die Fahrradnummer und den Schaden ein und meldet somit einen Schaden mit Klick
 * auf den Absendebutton
 */
...
public class ReportGUI extends VBox {
	...
	public ReportGUI() {
		 ...
		 * also das Eingabefeld fuer die Fahrradnummer
		 * die Beschreibung des Schadens
		 * und ein Button zum Absenden um den Schaden zu melden.
		 */
		public void init() {
